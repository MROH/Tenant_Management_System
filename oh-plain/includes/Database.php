 ...
 *
 * @author    axoblade <axoblade@gmail.com> & wildantea <wildannudin@gmail.com>
 * @copyright june 2020
 */
class Database
{
    ...
    ////upload image to and return file name
    function imgUpload($file)
    {
        ...
        if (empty($errors)) {
            ...
            if ($didUpload) {
                ...
                return 3;//"An error occurred. Please contact the administrator.";
            }
        }   
    }
